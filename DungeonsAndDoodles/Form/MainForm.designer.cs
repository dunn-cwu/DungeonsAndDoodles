namespace DungeonsAndDoodles
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.mainMenuStrip.Size = new System.Drawing.Size(1063, 28);
			...
			this.testTokenListItemToolStripMenuItem.Size = new System.Drawing.Size(150, 24);
			...
			// mainSplitContainer
			// 
			mainSplitContainer.BackColor = System.Drawing.SystemColors.ControlLight;
			...
			// 
			mainSplitContainer.Panel2.Controls.Add(this.rightPanelSplitContainer);
			mainSplitContainer.Panel2MinSize = 0;
			mainSplitContainer.Size = new System.Drawing.Size(1063, 653);
			mainSplitContainer.SplitterDistance = 734;
			mainSplitContainer.SplitterWidth = 8;
			mainSplitContainer.TabIndex = 1;
			mainSplitContainer.TabStop = false;
			mainSplitContainer.SplitterMoved += new System.Windows.Forms.SplitterEventHandler(this.mainSplitContainer_SplitterMoved);
			mainSplitContainer.DoubleClick += new System.EventHandler(this.mainSplitContainer_DoubleClick);
			// 
			...
			this.rightPanelSplitContainer.Margin = new System.Windows.Forms.Padding(4);
			...
			this.rightPanelSplitContainer.Size = new System.Drawing.Size(319, 651);
			this.rightPanelSplitContainer.SplitterDistance = 528;
			...
			this.rightPanelTabControl.Margin = new System.Windows.Forms.Padding(4);
			this.rightPanelTabControl.Name = "rightPanelTabControl";
			this.rightPanelTabControl.SelectedIndex = 0;
			this.rightPanelTabControl.Size = new System.Drawing.Size(319, 528);
			...
			// actTokRemoveBtn
			// 
			this.actTokRemoveBtn.Location = new System.Drawing.Point(196, 439);
			this.actTokRemoveBtn.Margin = new System.Windows.Forms.Padding(4);
			...
			// actTokEditBtn
			// 
			this.actTokEditBtn.Location = new System.Drawing.Point(102, 439);
			this.actTokEditBtn.Margin = new System.Windows.Forms.Padding(4);
			...
			// actTokLocateBtn
			// 
			this.actTokLocateBtn.Location = new System.Drawing.Point(9, 439);
			this.actTokLocateBtn.Margin = new System.Windows.Forms.Padding(4);
			...
			this.activeTokensList.Location = new System.Drawing.Point(9, 75);
			this.activeTokensList.Margin = new System.Windows.Forms.Padding(4);
			...
			this.activeTokEnemyFilterCheck.Margin = new System.Windows.Forms.Padding(4);
			...
			this.activeTokNonPlayerFilterCheck.Margin = new System.Windows.Forms.Padding(4);
			...
			this.activeTokPlayerFilterCheck.Margin = new System.Windows.Forms.Padding(4);
			...
			this.snapTokensToGridCheckbox.Location = new System.Drawing.Point(-149, -292);
			this.snapTokensToGridCheckbox.Margin = new System.Windows.Forms.Padding(4);
			...
			// ExportTokenButton
			// 
			this.ExportTokenButton.Location = new System.Drawing.Point(148, 474);
			this.ExportTokenButton.Margin = new System.Windows.Forms.Padding(3, 2, 3, 2);
			this.ExportTokenButton.Name = "ExportTokenButton";
			this.ExportTokenButton.Size = new System.Drawing.Size(129, 23);
			...
			// TokenImportButton
			// 
			this.TokenImportButton.Location = new System.Drawing.Point(9, 474);
			this.TokenImportButton.Margin = new System.Windows.Forms.Padding(3, 2, 3, 2);
			this.TokenImportButton.Name = "TokenImportButton";
			this.TokenImportButton.Size = new System.Drawing.Size(123, 23);
			...
			// editLibTokenBtn
			// 
			this.editLibTokenBtn.Location = new System.Drawing.Point(102, 439);
			this.editLibTokenBtn.Margin = new System.Windows.Forms.Padding(4);
			...
			// placeTokenOnMapBtn
			// 
			this.placeTokenOnMapBtn.Location = new System.Drawing.Point(9, 439);
			this.placeTokenOnMapBtn.Margin = new System.Windows.Forms.Padding(4);
			...
			this.tokenLibList.Location = new System.Drawing.Point(9, 76);
			this.tokenLibList.Margin = new System.Windows.Forms.Padding(4);
			this.tokenLibList.Name = "tokenLibList";
			this.tokenLibList.Size = new System.Drawing.Size(271, 356);
			...
			this.libEnemyFilterCheck.Margin = new System.Windows.Forms.Padding(4);
			...
			this.libNonplayerFilterCheck.Margin = new System.Windows.Forms.Padding(4);
			...
			this.libPlayerFilterCheck.Margin = new System.Windows.Forms.Padding(4);
			...
			// newLibTokenBtn
			// 
			this.newLibTokenBtn.Location = new System.Drawing.Point(196, 439);
			this.newLibTokenBtn.Margin = new System.Windows.Forms.Padding(4);
			...
			this.mapTabPage.Padding = new System.Windows.Forms.Padding(4);
			this.mapTabPage.Size = new System.Drawing.Size(311, 499);
			...
			// 
			this.ToggleLineColorButton.Location = new System.Drawing.Point(34, 516);
			this.ToggleLineColorButton.Name = "ToggleLineColorButton";
			this.ToggleLineColorButton.Size = new System.Drawing.Size(160, 25);
			...
			this.groupBox1.Size = new System.Drawing.Size(284, 348);
			...
			this.shiftGridRightBtn.Margin = new System.Windows.Forms.Padding(4);
			...
			this.shiftGridLeftBtn.Margin = new System.Windows.Forms.Padding(4);
			...
			this.shiftGridDownBtn.Margin = new System.Windows.Forms.Padding(4);
			...
			this.shiftGridUpBtn.Margin = new System.Windows.Forms.Padding(4);
			...
			this.resetGridPosBtn.Margin = new System.Windows.Forms.Padding(4);
			...
			this.gridScaleSlider.Margin = new System.Windows.Forms.Padding(4);
			this.gridScaleSlider.Minimum = 2;
			this.gridScaleSlider.Name = "gridScaleSlider";
			this.gridScaleSlider.Size = new System.Drawing.Size(264, 39);
			...
			this.gridAlphaSlider.Margin = new System.Windows.Forms.Padding(4);
			this.gridAlphaSlider.Maximum = 255;
			this.gridAlphaSlider.Name = "gridAlphaSlider";
			this.gridAlphaSlider.Size = new System.Drawing.Size(264, 38);
			...
			this.gridThicknessSlider.Margin = new System.Windows.Forms.Padding(4);
			this.gridThicknessSlider.Maximum = 6;
			this.gridThicknessSlider.Minimum = 1;
			this.gridThicknessSlider.Name = "gridThicknessSlider";
			this.gridThicknessSlider.Size = new System.Drawing.Size(264, 39);
			...
			this.viewGroupBox.Location = new System.Drawing.Point(8, 55);
			...
			this.viewGroupBox.Size = new System.Drawing.Size(295, 110);
			...
			this.resetViewBtn.Margin = new System.Windows.Forms.Padding(4);
			...
			this.centerViewBtn.Margin = new System.Windows.Forms.Padding(4);
			...
			// 
			this.loadMapBackgroundBtn.Location = new System.Drawing.Point(8, 14);
			this.loadMapBackgroundBtn.Margin = new System.Windows.Forms.Padding(4);
			...
			this.diceRollOutputLabel.Location = new System.Drawing.Point(9, 14);
			this.diceRollOutputLabel.Name = "diceRollOutputLabel";
			this.diceRollOutputLabel.Size = new System.Drawing.Size(302, 23);
			this.diceRollOutputLabel.TabIndex = 0;
			this.diceRollOutputLabel.Click += new System.EventHandler(this.label4_Click);
			// 
			// rollDiceBtn
			// 
			this.rollDiceBtn.Location = new System.Drawing.Point(239, 49);
			this.rollDiceBtn.Margin = new System.Windows.Forms.Padding(4);
			...
			this.NumberOfSidesLabel.Location = new System.Drawing.Point(13, 86);
			this.NumberOfSidesLabel.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
			this.NumberOfSidesLabel.Name = "NumberOfSidesLabel";
			this.NumberOfSidesLabel.Size = new System.Drawing.Size(113, 17);
			...
			this.NumberOfDiceLabel.Location = new System.Drawing.Point(13, 52);
			this.NumberOfDiceLabel.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
			this.NumberOfDiceLabel.Name = "NumberOfDiceLabel";
			this.NumberOfDiceLabel.Size = new System.Drawing.Size(106, 17);
			this.NumberOfDiceLabel.TabIndex = 3;
			this.NumberOfDiceLabel.Text = "Number of Dice";
			// 
			// NumberOfSidesUpDown
			// 
			this.NumberOfSidesUpDown.Location = new System.Drawing.Point(139, 84);
			this.NumberOfSidesUpDown.Margin = new System.Windows.Forms.Padding(4);
			...
			this.NumberOfSidesUpDown.Size = new System.Drawing.Size(86, 22);
			...
			// NumberOfDiceUpDown
			// 
			this.NumberOfDiceUpDown.Location = new System.Drawing.Point(139, 49);
			this.NumberOfDiceUpDown.Margin = new System.Windows.Forms.Padding(4);
			...
			this.NumberOfDiceUpDown.Size = new System.Drawing.Size(86, 22);
			...
			this.MapPanel.Controls.Add(this.ToggleLineColorButton);
			...
			this.MapPanel.Size = new System.Drawing.Size(303, 491);
